		...
		<c:choose>
					...
					<tbody>
						<c:forEach var="participant" items="${participants}">
							<tr>
								...
								<td>${participant.primarySkills}</td>
			...
			<c:when test="${mode == 'PARTICIPANT_EDIT' || mode == 'PARTICIPANT_CREATE'}">
				...
				<input type="hidden" value="${participant.id}" class="form-control" id="id" name="id">
					...
					<div class="form-group">
						<label for="primarySkills">Primary Skills:</label> <input type="text"
							class="form-control" id="primarySkills" name="primarySkills"
							value="${participant.primarySkills}">
					</div>
